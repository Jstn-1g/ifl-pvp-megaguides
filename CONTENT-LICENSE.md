# Content, data, and brand boundary

This repository makes the **site software and tooling** available under the [MIT License](LICENSE). It does not grant one license to every kind of material that could be associated with IFL PvP MegaGuides.

| Material | Public-candidate treatment | Terms |
| --- | --- | --- |
...
Code contributions are accepted under MIT through the sign-off process in [CONTRIBUTING.md](CONTRIBUTING.md). Do not submit editorial material, data, brand assets, or media unless a maintainer has specifically requested it and accepted a complete rights record. A source link or correction is generally preferable to copying protected material.

Questions about permission or a rights concern belong in the private process described in [NOTICE.md](NOTICE.md).
