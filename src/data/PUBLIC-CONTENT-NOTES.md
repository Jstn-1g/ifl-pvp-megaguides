...
`public-content.ts` is the entire editorial-data boundary for the first public
release candidate. It contains five newly authored, image-free route records:
four review-due MegaGuide summaries and one Bloodline Champions
evidence-reconstruction notice.

## Intentional omissions

No legacy route manifest is included in this candidate. The private archive
...
The candidate deliberately excludes the former article bodies, frontmatter
...
synchronized datasets. Those materials remain in the private canonical
