...
The public release contains six approved first-party presentation assets: the reserved IFL PvP logo, two project-directed franchise-neutral illustrations, the social card generated with the logo, and two local-build interface captures recorded in the public asset allowlist. The standalone logo and both illustrations remain outside the MIT code license. The genre-world scene and simplified fantasy arena silhouettes are decorative original art—not screenshots, publisher art, or representations of any covered game. Publisher game artwork, gameplay screenshots, video, audio, publisher logos, third-party fonts, author portraits, collected source media, and any unreviewed social asset are excluded.
