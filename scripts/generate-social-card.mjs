...
function cardMarkup(logoDataUrl, worldsDataUrl) {
  return `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta http-equiv="Content-Security-Policy" content="default-src 'none'; img-src data:; style-src 'unsafe-inline'"><style>
    *{box-sizing:border-box}html,body{margin:0;width:${width}px;height:${height}px;overflow:hidden;background:#0b1830;color:#fff}
    ...
    .genres{display:flex;gap:8px;margin-top:32px}.genres span{display:flex;align-items:center;gap:7px;padding:8px 10px;border:1px solid rgba(255,255,255,.24);background:rgba(7,18,36,.55);color:#fff;font-size:12px;font-weight:800;letter-spacing:.09em;text-transform:uppercase;backdrop-filter:blur(9px)}.genres i{width:7px;height:7px;border-radius:50%;background:#72d7ff}.genres span:nth-child(2) i{background:#73f0ca}.genres span:nth-child(3) i{background:#ff9b5e}.genres span:nth-child(4) i{background:#e67aff}
